...
|---|---|---|
| [01](exercises/01-remove-the-approval-gate.md) | Remove the approval gate | What a load-bearing mechanism looks like: 14 of 25 evals fail, across five invariants |
| [02](exercises/02-remove-the-invisible-layer.md) | Remove the fence | **The one worth doing.** Delete the most visible anti-injection defence and 22 of 25 evals keep passing |
