...
Measured, on the 19 trajectory evals:

| Layer removed | Evals that fail |
|---|---|
| The approval gate (`requires_approval` → `False`) | **11 of 19** |
...
feature. Here that is 19 trajectory evals wired into CI as a required step,
